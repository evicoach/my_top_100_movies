...
const { ENCRYPTION_KEY, INITIALIZATION_VECTOR } = require("../config/constants");

// First we get our unique key to encrypt our object
var password = ENCRYPTION_KEY;

// We then get our unique Initialization Vector
// var iv = Buffer.from(INITIALIZATION_VECTOR);

const iv = new Buffer.from(INITIALIZATION_VECTOR)
